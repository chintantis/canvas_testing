...
const Comeight = () => {
    ...
    return (
        <>
            <Box>
                <Grid container>
                    <Grid item lg={9} md={9} xs={9} sx={{ backgroundColor: '#4ca1ff', paddingLeft: 8 }}>
                        <Box className={style.bgimgg}>
                            <Box className='container'>
                                <Medium_text style={{ fontSize: 35, width: '34%', textAlign: 'left', color: 'white' }}>Download the Avendy
                                ...
                                <Grid container mt={4} mb={5} width={'46%'}>
                                    <GooglePlayBadge
                                        icon={icon}
