...
const ComThree = () => {
    const mobile = (
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="25" style={{ padding: 12 }} viewBox="0 0 36 36" fill="none">
    ...
    const network = (
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="25" style={{ padding: 10 }} viewBox="0 0 36 32" fill="none">
    ...
    const people = (
        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="30" style={{ padding: 9 }} viewBox="0 0 33 36" fill="none">
    ...
    const cloud = (
        <svg xmlns="http://www.w3.org/2000/svg" width="34" height="27" style={{ padding: 9 }} viewBox="0 0 36 36" fill="none">
    ...
    return (
        <>
            <Box className="container">
                <Grid container mt={6}>
                    <Grid item lg={6}>
                        <Box height={340} width={530} sx={{ background: '#f3f3ff', borderRadius: 4, mt: 25 }}></Box>
                    </Grid>
                    <Grid item lg={6} textAlign={'left'} mb={13}>
                        ...
                        <Box display={'flex'} mt={3}>
                            <Box height={50} width={50} sx={{ background: '#f3f3ff', borderRadius: 3, m: 1.3 }}>
                                {mobile}
                            </Box>
                            <Box>
